<?php
/**
 * Own Shop Magazine functions and definitions.
 *
...
define('OWN_SHOP_THEME_RATINGS_URL','https://wordpress.org/support/theme/own-shop/reviews/');
define('OWN_SHOP_THEME_CHANGELOGS_URL','https://themes.trac.wordpress.org/log/own-shop/');
define('OWN_SHOP_THEME_CONTACT_URL','https://www.spiraclethemes.com/contact-us/');
...
function own_shop_scripts() {
	...
	wp_enqueue_style( 'own-shop-style', get_stylesheet_uri() );
	...
	wp_enqueue_style( 'own-shop-responsive', get_template_directory_uri() . '/css/style-responsive.min.css', array(), wp_get_theme()->get('Version'));
	...
	wp_enqueue_style( 'josefin-sans-google-font', 'https://fonts.googleapis.com/css2?family=Josefin+Sans:wght@300;400;600;700&display=swap', array(), '1.0');   
 ...
 */
if ( ! function_exists( 'own_shop_after_import_setup' ) ) :
function own_shop_after_import_setup() {    
...
add_action( 'pt-ocdi/after_import', 'own_shop_after_import_setup' );
