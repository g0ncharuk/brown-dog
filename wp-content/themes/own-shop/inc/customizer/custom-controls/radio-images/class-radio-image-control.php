...
// Exit if Own_Shop_Radio_Image_Control exists and WP_Customize_Control does not exsist.
if ( class_exists('Own_Shop_Radio_Image_Control') && ! class_exists( 'WP_Customize_Control' ) ) :
	return null;
endif;
 ...
 * @access public
 */
class Own_Shop_Radio_Image_Control extends WP_Customize_Control {
	 ...
	 * @var string
	 */
	public $type = 'own-shop-radio-image';
	...
	public function enqueue() {
        ...
        wp_enqueue_style( 'own-shop-radio-image-control-css', get_parent_theme_file_uri( 'inc/customizer/custom-controls/radio-images/radio-image.css', array(), '1.0', 'all' ));
	}
